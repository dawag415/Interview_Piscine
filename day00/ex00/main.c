...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/10/09 10:24:54 by iwagner           #+#    #+#             */
/*   Updated: 2017/10/09 10:24:57 by iwagner          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	printf("price for the art \'%s\' is %d\n", "BOOTYLICIOUS", searchPrice(arts, "BOOTYLICIOUS"));
	printf("price for the art \'%s\' is %d\n", "The Debacles", searchPrice(arts, "The Debacles"));
	printf("price for the art \'%s\' is %d\n", "asdf", searchPrice(arts, "asdf"));
	printf("price for the art \'%s\' is %d\n", "UNTITLED", searchPrice(arts, "UNTITLED"));
	return (0);
}
